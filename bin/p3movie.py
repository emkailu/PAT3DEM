...
def main():
	...
	parser.add_argument("-s", "--save", type=str, help="save a specified number of aligned frames, by default {}, which means do not save. e.g., '2 21 4' means the saved movie starts from frame #2 (#0 is the first), ends at #21, in total (21-2+1)/4 = 5 frames".format(args_def['save']))
	...
	if len(sys.argv) == 1:
		...
		for movie in args.movie:
			...
			com = basename + '_unblur.com'
			with open(com, 'w') as write_com:
				if args.save == '0 0 0':
					write_com.write('{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n'.format(softlink, unblur, in_movie, nimg, out_sum, out_shift, args.apix, dose_filter, dose, 200, 0, 'no', 'no', 'eof'))
				else:
					write_com.write('{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n'.format(softlink, unblur, in_movie, nimg, out_sum, out_shift, args.apix, dose_filter, dose, 200, 0, 'yes', out_movie, 'no', 'eof'))
			...
			if args.save != '0 0 0':
				...
				ld_movie = basename+'_lowdose_movie.mrcs'
				subprocess.call(['relion_image_handler', '--i', out_movie+'s', '--o', ld_movie, '--avg_bin', avg_bin])
				os.remove(out_movie+'s')
				# generate lowdose sum
				subprocess.call(['relion_image_handler', '--i', ld_movie, '--o', basename+'_lowdose.mrc', '--avg_first', '1', '--avg_last', str((int(last)-int(first)+1)/int(avg_bin))])
